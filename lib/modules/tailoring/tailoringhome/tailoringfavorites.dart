...
import '../tailoringmen.dart';

class Tailoringfavorites extends StatefulWidget {
  const Tailoringfavorites({Key? key}) : super(key: key);

  @override
  _TailoringfavoritesState createState() => _TailoringfavoritesState();
}

class _TailoringfavoritesState extends State<Tailoringfavorites> {
                ...
                Container(
                  ...
                  child: GridView.builder(
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      return defaultTailoringfaviorites(
                          context, Tailoringfavioritespage[index]);
                    },
                    itemCount: Tailoringfavioritespage.length,
                  ),
                ),
              ],
            ),
