...
class TailoringDetailsmodel extends StatefulWidget {
  const TailoringDetailsmodel({Key? key}) : super(key: key);

  @override
  _TailoringDetailsmodelState createState() => _TailoringDetailsmodelState();
}

class _TailoringDetailsmodelState extends State<TailoringDetailsmodel> {
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                defaultBoldText('Hello Alyaa Ahmed', 20),
                SizedBox(
                  height: 5,
                ),
                defaultNormalText(
                  'Design your design with following properties',
                  15,
                  MyColors.mygray1,
                ),
                SizedBox(
                    ...
                    Container(
                      ...
                      child: TextFormField(
                        decoration: InputDecoration(
                          ...
                          contentPadding:
                              EdgeInsets.only(top: 20, left: 40, bottom: 10),
                          filled: true,
                          hintText: 'Quantity',
                        ),
                      ),
                      ...
                      child: InkWell(
                        onTap: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => const Tailoringfavorites(),
                            ),
                          );
                        },
