...
import 'package:kiswaa/modules/categories/alrajulalmotmiz/widget.dart';
import 'package:kiswaa/modules/categories/category/category.dart';
import 'package:kiswaa/modules/loginscreen/widget.dart';
import 'package:kiswaa/shared/colors.dart';

class AlrajulAlmotmiz extends StatefulWidget {
  const AlrajulAlmotmiz({Key? key}) : super(key: key);

  @override
  _AlrajulAlmotmizState createState() => _AlrajulAlmotmizState();
}

class _AlrajulAlmotmizState extends State<AlrajulAlmotmiz> {
    ...
    return SafeArea(
      child: Scaffold(
        appBar: AppBar(
          ...
          elevation: 0,
          centerTitle: true,
          title: defaultBoldText('Alrajul Almotmiz', 22),
          leading: InkWell(
            onTap: () {
              Navigator.push(
                ...
                Container(
                  ...
                  child: GridView.builder(
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      return defaultAlrajulAlmotmizgridview(
                          context, AlrajulAlmotmizpage[index]);
                    },
                    itemCount: AlrajulAlmotmizpage.length,
                  ),
                ),
              ],
            ),
