...
import 'package:kiswaa/modules/categories/shmagh/widget.dart';
import 'package:kiswaa/modules/loginscreen/widget.dart';
import 'package:kiswaa/shared/colors.dart';

class Shmagh extends StatefulWidget {
  const Shmagh({Key? key}) : super(key: key);

  @override
  _ShmaghState createState() => _ShmaghState();
}

class _ShmaghState extends State<Shmagh> {
    ...
    return SafeArea(
      child: Scaffold(
        appBar: AppBar(
          ...
          elevation: 0,
          centerTitle: true,
          title: defaultBoldText('Shmagh', 22),
          leading: InkWell(
            onTap: () {
              Navigator.push(
                  context, MaterialPageRoute(builder: (context) => MenWear()));
            },
            child: Icon(
              ...
              Container(
                ...
                child: GridView.builder(
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    return defaultShmaghgridview(context, shmaghpage[index]);
                  },
                  itemCount: shmaghpage.length,
                ),
              ),
            ],
          )),
