...
import 'package:kiswaa/modules/categories/woman/widget.dart';
...
class WomanClothes extends StatefulWidget {
  const WomanClothes({Key? key}) : super(key: key);

  @override
  _WomanClothesState createState() => _WomanClothesState();
}
              ...
              Container(
                ...
                child: ListView.separated(
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      return defaultStackCategoriesWoman(
                          context, categorywomanpage[index]);
                    },
                    ...
                    itemCount: categorywomanpage.length),
              ),
              SizedBox(height: 15),
              defaultBoldText(
                'You May Like',
