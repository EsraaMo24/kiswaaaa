...
import 'package:kiswaa/modules/categories/category/widget.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        elevation: 0,
        centerTitle: true,
        title: defaultBoldText('Category', 22),
        leading: InkWell(
          onTap: () {
            ...
            Container(
              ...
              child: GridView.builder(
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    return defaultategoriesgridview(
                        context, categoriespage[index]);
                  },
