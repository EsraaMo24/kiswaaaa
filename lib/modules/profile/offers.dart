...
class _OffersState extends State<Offers> {
  ...
  void _showbtnsheetoffer(BuildContext ctx) {
  ...
  Widget defaultOffer(context, Offerpage model) {
        ...
        child: Stack(
          children: [
            InkWell(
              ...
              onTap: () => _showbtnsheetoffer(context),
            ),
            Positioned(
              top: 20,
              right: 0,
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        centerTitle: true,
        title: defaultBoldText('Offers', 22),
        leading: InkWell(
          onTap: () {
            Navigator.push(
          ...
          children: [
            Container(
              ...
              child: GridView.builder(
                ...
                itemCount: pageoffer.length,
                itemBuilder: (BuildContext context, int index) {
                  return defaultOffer(context, pageoffer[index]);
                },
              ),
            ),
          ],
